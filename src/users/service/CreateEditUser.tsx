  ...
  return (
    <div className="container">
        ...
        initialValues={{
            ...
            email: user.email,
            address_street: user.address && user.address.street?user.address.street:'',
            address_suite: user.address && user.address.suite?user.address.suite:'',
            address_city: user.address && user.address.city?user.address.city:'',
            address_zipcode: user.address && user.address.zipcode?user.address.zipcode:'',
            address_geo_lat: user.address && user.address.geo && user.address.geo.lat?user.address.geo.lat:'',
            address_geo_lng: user.address && user.address.geo && user.address.geo.lng?user.address.geo.lng:'',
            phone: user.phone,
